...
```bash
 npx create-next-app --example with-cloudinary BloodRun-Gallery
```

```bash
yarn create next-app --example with-cloudinary BloodRun-Gallery
```

```bash
pnpm create next-app --example with-cloudinary BloodRun-Gallery
```
